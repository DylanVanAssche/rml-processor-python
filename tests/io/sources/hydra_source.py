...
class HydraLogicalSourceTests(unittest.TestCase):
    ...
    def test_iterator_jsonld(self) -> None:
        ...
        # Hydra page 0
        connection = next(source)
        self.assertEqual(connection['connection'], URIRef('http://irail.be/connections/8883808/20200619/IC1717'))
        self.assertEqual(connection['departure'], URIRef('http://irail.be/stations/NMBS/008883808'))
        self.assertEqual(connection['arrival'], URIRef('http://irail.be/stations/NMBS/008814332'))
        connection = next(source)
        self.assertEqual(connection['connection'], URIRef('http://irail.be/connections/8814159/20200619/IC2039'))
        self.assertEqual(connection['departure'], URIRef('http://irail.be/stations/NMBS/008814159'))
        self.assertEqual(connection['arrival'], URIRef('http://irail.be/stations/NMBS/008814167'))

        # Hydra page 1
        connection = next(source)
        self.assertEqual(connection['connection'], URIRef('http://irail.be/connections/8895430/20200619/P8903'))
        self.assertEqual(connection['departure'], URIRef('http://irail.be/stations/NMBS/008895430'))
        self.assertEqual(connection['arrival'], URIRef('http://irail.be/stations/NMBS/008895422'))
        connection = next(source)
        self.assertEqual(connection['connection'], URIRef('http://irail.be/connections/8813003/20200619/IC2118'))
        self.assertEqual(connection['departure'], URIRef('http://irail.be/stations/NMBS/008813003'))
        self.assertEqual(connection['arrival'], URIRef('http://irail.be/stations/NMBS/008813045'))

        # Hydra page 2
        connection = next(source)
        self.assertEqual(connection['connection'], URIRef('http://irail.be/connections/8833274/20200619/IC2640'))
        self.assertEqual(connection['departure'], URIRef('http://irail.be/stations/NMBS/008833274'))
        self.assertEqual(connection['arrival'], URIRef('http://irail.be/stations/NMBS/008833266'))
        connection = next(source)
        self.assertEqual(connection['connection'], URIRef('http://irail.be/connections/8811262/20200619/IC2240'))
        self.assertEqual(connection['departure'], URIRef('http://irail.be/stations/NMBS/008811262'))
        self.assertEqual(connection['arrival'], URIRef('http://irail.be/stations/NMBS/008811254'))
