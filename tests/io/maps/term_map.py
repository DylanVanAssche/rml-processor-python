...
from rml.io.maps import TermMap, TermType
...
class TermMapTests(unittest.TestCase):
    def test_invalid_xpath(self) -> None:
        ...
        with self.assertRaises(NameError):
            m = MockTermMap('term', TermType.REFERENCE, MIMEType.TEXT_XML)
    ...
    def test_invalid_jsonpath(self) -> None:
        ...
        """
        with self.assertRaises(NameError):
            m = MockTermMap('term', TermType.REFERENCE, MIMEType.JSON)
    ...
    def test_empty_result_xpath(self) -> None:
        ...
        with self.assertRaises(ResourceWarning):
            m = MockTermMap('age', TermType.REFERENCE, MIMEType.TEXT_XML)
    ...
    def test_empty_result_jsonpath(self) -> None:
        ...
        """
        with self.assertRaises(ResourceWarning):
            m = MockTermMap('name', TermType.REFERENCE, MIMEType.JSON)
